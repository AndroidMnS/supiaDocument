...
<%
    String strBtnCategory =  request.getParameter("productCategory");
    ...
    String WhereDefault1 = "Left join liked on product.productno = liked.likeproductid where productCategory1 ";
    String WhereDefault2 = "like '%" + strBtnCategory + "%' order by productPrice " + array ; 
