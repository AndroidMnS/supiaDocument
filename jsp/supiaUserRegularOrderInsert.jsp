...
<%
	...
	String subscribeProductName = request.getParameter("subscribeProductName");
	String subscribeProductPrice = request.getParameter("subscribeProductPrice");
...
//------
	...
	try{
	    ...
	    String A = "insert into subscribeOrder (subscribeOrderDate, subscribeOrderQuantity, subscribeOrderTel, subscribeOrderAddr, subscribeOrderAddrDetail, subscribeOrderPayment, subscribeOrderTotalPrice, userId, productId,subscribeProductName,subscribeProductPrice ";
	    String B = ") values (?,?,?,?,?,?,?,?,?,?,?)";
		...
		ps.setString(10, subscribeProductName);
	    ps.setString(11, subscribeProductPrice);
