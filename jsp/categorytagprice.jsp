...
<%
    ...
    String WhereDefault = "select productNo, productName, productPrice, productQuantity, productBrand, ";
    String WhereDefault1 = "productImagePath, productInfo, productCategory1, productCategory2 ";
    String WhereDefault2 = "from product Where productCategory2 like '%" + strBtntag + "%' order by productPrice " + array";
